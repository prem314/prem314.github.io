...
\begin{itemize}[leftmargin=*,label={}]
    \item \textbf{Ph.D. in Theoretical Physics} \hfill 2021-Present \\
          ...
          Supervisor: \href{https://scholar.google.com/citations?user=zr0J0lMAAAAJ&hl=en&oi=ao}{Prof. Sibasish Ghosh}
...
\begin{itemize}[leftmargin=*]
	\item Developed an analytical 4th-order Time-Convolutionless (TCL4) generator for Spin-Boson models, benchmarking it against exact numerical methods.
...
\begin{enumerate}[leftmargin=*,label=\arabic*.]
    \item Prem Kumar, K. P. Athulya, and Sibasish Ghosh. \textbf{``Asymptotic TCL4 Generator for the Spin-Boson Model: Analytical Derivation and Benchmarking."} \textit{\href{https://doi.org/10.1103/69y3-x6vh}{Physical Review B}} (accepted, 2025).
