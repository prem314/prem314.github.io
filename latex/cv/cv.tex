...
\begin{itemize}[leftmargin=*]
	...
	\item Generalized the ultra-strong coupling limit quantum mean force Gibbs state to a large class of anharmonic environments.~\cite{Kumar2024Anharm}
\end{itemize}


\sectionheading{Research Interests}

My main research interests lie in the areas of open quantum systems. This includes its theoretical study as well application to physically/experimentally relevant models like those found in chemical, biological or other many-body systems. I require a combination of analytical and numerical techniques to study the system in question. I am also interested in related topics like non-Markovianity, Quantum Thermodynamics and other topics in quantum information theory.

Other than this, I am also keen on exploring systems with indistinguishable particles and many body quantum systems.
