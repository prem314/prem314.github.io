...
\begin{enumerate}[leftmargin=*,label=\arabic*.]
    \item Prem Kumar, K. P. Athulya, and Sibasish Ghosh. \textbf{``Equivalence between the second order steady state for the spin-boson model and its quantum mean force Gibbs state."} \textit{Physical Review B} 111, 115423 (2025).
    \item Prem Kumar, and Sibasish Ghosh. \textbf{``Ultrastrong coupling limit to quantum mean force Gibbs state for anharmonic environment."} \textit{The Journal of Chemical Physics} 161, 17 (2024).
\end{enumerate}

\textbf{\textit{Submitted Work \& Preprints}}
\begin{enumerate}[leftmargin=*,label=\arabic*.,resume]
    \item Prem Kumar, K. P. Athulya, and Sibasish Ghosh. \textbf{``Asymptotic TCL4 Generator for the Spin-Boson Model: Analytical Derivation and Benchmarking."} arXiv preprint arXiv:2506.17009 (2025).
\end{enumerate}

\textbf{\textit{Pedagogical Reviews}}
\begin{itemize}[leftmargin=*]
    \item Prem Kumar. \textbf{``Local harmonic approximation to quantum mean force Gibbs state"} arXiv:2401.11595 (2024).
    \\[0.1cm]
