...
\begin{itemize}[leftmargin=*]
    \item \textbf{Corrections to a quantum dissipative dynamics in higher order of the noise strength:}
    \begin{itemize}
        ...
        \item This work resulted in an open-source package for that can be found on my GitHub: \href{https://github.com/prem314/spin-boson-tcl4}{\texttt{spin-boson-tcl4}}.
    \end{itemize}
...
I am currently focusing to expand the scope of research in the following directions:
\begin{itemize}[leftmargin=*]
    \item Application of open quantum system techniques to study systems of physical interest. For example, I am studying the phenomenon of Chirality induced spin selectivity (CISS), specifically focusing on the temperature dependence of the phenomenon. I am also investigating some mechanism through which CISS can be observed in absence of phonons.
    \item Higher order TCL master equation has been recently reported to have long time divergence if the bath correlator has algebraic tail. I performing a detailed study the origin of this divergence using exactly solvable models and trying to find techniques to mitigate it and exploring other computationally efficients master equations that can circumvent this issue.
    \item Deriving ultrastrong coupling master equation for anharmonic environments and studying its consistency with the corresponding generalized Gibbs state derived in my work \cite{Kumar2024Anharm}. 
    \item Recent research has revealed some general results on various constraints on the state space of a symmetric molecule with indistinguishable nuclei. This opens up an avenue for physical effects in large molecular systems originating directly from a purely quantum mechanical effect.
    I am studying the physical implications of these results for example in certain chemical reaction. I am also interested in generalization of these results.
\end{itemize}
