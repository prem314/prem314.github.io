...
\begin{center}
    \colorbox{nottblue!100}{%
        \begin{minipage}[t]{\textwidth} % Adjusted vertical alignment
            ...
            \begin{center}
                {\fontsize{85pt}{85pt}\selectfont\textbf{\textcolor{white}{Asymptotic fourth-order time-convolutionless generator for the spin-boson model: Analytical derivation and benchmarking}}}\\[1ex] % Increased font size
...
\begin{minipage}[t]{0.48\textwidth}
  ...
  \begin{itemize}[leftmargin=0.8em, label={}, itemsep=0.4em, topsep=0pt, parsep=0pt]
    ...
    \item Prem Kumar, K. P. Athulya, \& Sibasish Ghosh. (2026). Asymptotic fourth-order time-convolutionless generator for the spin-boson model: Analytical derivation and benchmarking. \textit{Phys. Rev. B}, \textbf{113}(4), 045404.
